...
//    RotateOverLine: function(object, line, angle){
//        console.log(object);
//        var returnObject = object.clone();
//        
//        var axis = verb.core.Vec.sub(line.start(), line.end());
//        
//        var quat = this.QatFromaxisangle(axis, angle);
//        
//        var matRot = this.QuatToMatrix(quat);
//        
//        //what I do now is wrong, I shoudl incorporate
//        //the translation over a line in a matrix
//        //instead I translate the origin back and forth
//        var transVec = line.start();
//        
//        var matTrans = [[1,0,0,-transVec[0]],
//                        [0,1,0,-transVec[1]],
//                        [0,0,1,-transVec[2]],
//                        [0,0,0,1]]
//        
//        returnObject.transform(matTrans);
//        
...
//    },
    ...
    Polygon: function (center, xAxis, yAxis, sides, radius) {
        ...
        for(var i = 0; i < sides; i++){
            ...
            points[i] = [x + center[0], y + center[1] ,0 + center[2]];
        }
