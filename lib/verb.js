...
verb_geom_NurbsCurve.prototype = $extend(verb_core_SerializableBase.prototype,{
	...
	,clone: function() {
                //changed to make this shit work
            
                // copy the control points
                var pts = this._data.controlPoints;
                ...
                var data = new verb_core_NurbsCurveData(this.degree()
                    ,this.knots().slice(0)
                    ,pts_copy
                    ,this.weights().slice(0) );
                
                return new verb_geom_NurbsCurve(data);
            
            //original only uses function below
