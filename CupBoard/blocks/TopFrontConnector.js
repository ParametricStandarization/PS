/* global OpenPlus, THREE */

TopFrontConnector = function (
    ...
    sideCon.buildTopHolder(true);

    var frontCon = protoWallConnector.clone();
    frontCon.buildTopHolder(false);
...
TopFrontConnector.prototype.mesh = function (translation, rotation, scale, flip) {
